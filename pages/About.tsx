...
const About: React.FC = () => {
  ...
  return (
    <div className="bg-charcoal text-ivory">
      {/* About Header */}
      <section className="py-48 bg-charcoal relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 text-center">
          <span className="reveal text-gold text-[10px] uppercase tracking-[0.5em] font-bold mb-8 block">Legacy & Vision</span>
          <h1 className="reveal delay-150 text-7xl md:text-[10rem] font-serif italic mb-12 text-ivory leading-none">Our Story</h1>
          <p className="reveal delay-300 max-w-3xl mx-auto text-stone text-2xl leading-relaxed italic font-serif opacity-70">
      ...
      {/* Main Content */}
      <section className="py-48 border-y border-gold/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            ...
            <div className="space-y-12">
              <h2 className="reveal text-5xl font-serif italic text-gold leading-tight">Elevated & Welcoming</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10">
                 ...
                 <div className="reveal delay-400 space-y-4">
      ...
      <section className="py-48 bg-charcoal-light">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-24">
            <h2 className="reveal text-5xl md:text-7xl font-serif italic text-ivory">The Hands Behind</h2>
            <p className="reveal delay-200 text-gold text-[10px] uppercase tracking-[0.5em] font-bold mt-6">Hospitality with Intention</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              <div key={i} className="text-center group">
                <div className={`reveal reveal-scale delay-${(i + 1) * 150} aspect-[4/5] rounded-[2rem] overflow-hidden mb-8 border border-gold/10 group-hover:border-gold/30 transition-all`}>
                ...
                <h3 className={`reveal delay-${(i + 1) * 150 + 100} text-3xl font-serif italic text-ivory mb-2`}>{member.name}</h3>
                <p className={`reveal delay-${(i + 1) * 150 + 200} text-[10px] uppercase tracking-widest text-gold font-bold opacity-60`}>{member.role}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col md:flex-row items-center justify-around gap-20">
             {['Craftsmanship', 'Innovation', 'Intention'].map((v, idx) => (
               <div key={idx} className={`reveal reveal-blur delay-${idx * 200} flex items-center gap-6`}>
